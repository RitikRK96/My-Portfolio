...
const Photos = () => {
    ...
    const [filteredPhotos, setFilteredPhotos] = useState<typeof photos>([]);
    ...
    return (
        <div className="pb-20">
            <div className="text-center mb-10" data-aos="fade-down">
                <h1 className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-pink-400 to-yellow-400 mb-4 inline-block pb-2">
                    Gallery
                </h1>
                ...
                <div className="columns-1 md:columns-2 lg:columns-3 gap-4 space-y-4 px-2 md:px-0">
                    {filteredPhotos.map((photo) => (
                        <div key={photo.id} className="break-inside-avoid relative group rounded-xl overflow-hidden mb-4" data-aos="zoom-in">
                            <img src={photo.imageUrl} alt={photo.caption} className="w-full h-auto object-cover transform transition-transform duration-700 group-hover:scale-110" />
